...
<div class="container">
  ...
  <p class="text-center"><em>Opisz swój problem</em></p>
  <div class="row test">
    <div class="col-md-4">
...
?>
        ...
        <div class="col-sm-6 form-group">
          ...
          Podaj email:<input class="form-control" id="email" name="email" placeholder="email" type="email" >
        </div>
        <div class="col-sm-6 form-group">
        Podaj problem:<select class="form-control" id="problem" name="problem" placeholder="problem" type="text" required>
        <?php 
$servername = "localhost";
$username = "root";
$password = "";
...
?>
      ...
      <textarea class="form-control" id="opis" name="opis" placeholder="opis problemu" rows="3"></textarea>
      <div class="row">
