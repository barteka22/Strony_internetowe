...
<div class="container">
  ...
  <div class="row test">
    <div class="col-md-4">
      ...
      <button type="button" class="btn btn-dark">Nowe zgłoszenia</button>
</a>
      <a href="wyloguj.php">
...
$sql = "select zgloszenia.zwrot,zgloszenia.opis,zgloszenia.id,zgloszenia.email,zgloszenia.rozwiazane,problem.problem,sala.sala from problem INNER JOIN zgloszenia ON zgloszenia.problem=problem.id INNER JOIN sala ON zgloszenia.sala=sala.id WHERE   zgloszenia.rozwiazane = 'rozwiazane'";
