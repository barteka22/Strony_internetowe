...
$zwrotradio = $_POST["zwrotradio"];
$opis = $_POST["$zwrotradio"];

$conn = mysqli_connect($servername, $username, $password,$dbname);


$sql2 = "UPDATE zgloszenia SET rozwiazane = 'rozwiazane' WHERE zgloszenia.id = $flexRadioDefault";
mysqli_query($conn, $sql2);

$sql3 = "UPDATE zgloszenia SET zwrot = '$opis' WHERE zgloszenia.id = $zwrotradio";
